...
class Fade:
    ...
    def calculate_max_value(self, sequence, fade_fcurve) -> None:
        """Returns the maximum Y coordinate the fade animation should use for a given sequence
        Uses either the sequences value for the animated property, or the next keyframe after the fade
...
class SequencerFadesAdd(bpy.types.Operator):
    ...
    def calculate_fade_duration(self, context, sequence) -> None:
        """
    ...
    def calculate_fades(
        self, sequence, fade_fcurve, animated_property, duration
    ) -> None:
    ...
    def fade_find_or_create_fcurve(self, context, sequence, animated_property) -> None:
    ...
    def is_long_enough(self, sequence, duration=0.0) -> None:
        """
